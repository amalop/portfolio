...
const skills = [
  //Languages
  { name: "PHP", level: 95, category: "languages" },
  ...
  { name: "Codeigniter 4", level: 80, category: "backend" },
  { name: "Yii 1", level: 80, category: "backend" },
  { name: "Yii 2", level: 60, category: "backend" },
  { name: "Django", level: 60, category: "backend" },

  // Tools
  { name: "Git/GitHub", level: 90, category: "tools" },
  { name: "VS Code", level: 90, category: "tools" },
  { name: "C Panel", level: 60, category: "tools" },
  { name: "Mantis", level: 80, category: "tools" },
];
